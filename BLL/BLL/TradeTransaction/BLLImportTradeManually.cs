    ...
    public class BLLImportTradeManually
    {
        public CResult GetImportTradeManuallyControl()
        {
            ...
            try
            {
                ...
                FROM [TBL_INSTRUMENT_BUY_SELL_DAILY_TEMP] IBS
        ...
        public CResult InsertImportTradeManually(Dictionary<String, String> oParams)
        {
            CResult CResult = new CResult();
            String Query = @"
            INSERT INTO dbo.TBL_INSTRUMENT_BUY_SELL_DAILY_TEMP
        ...
        {
            CResult CResult = new CResult();
            String Query = @"UPDATE dbo.TBL_INSTRUMENT_BUY_SELL_DAILY_TEMP
            SET
        ...
        {
            CResult CResult = new CResult();
            String Query = @"UPDATE TBL_INSTRUMENT_BUY_SELL_DAILY_TEMP
            SET
            IsDeleted=1
