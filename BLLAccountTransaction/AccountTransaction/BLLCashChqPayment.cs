...
namespace BLL
{
    public class BLLCashChqPayment
    {
        ...
        public  CResult GetDropDownControlData(String BRANCH_ID)
        {
            ...
            String Query = @"SELECT 0 Value,'--Select--' Text UNION SELECT ID,BANK_ACCOUNT_NO 'Text' FROM TBL_ACCOUNTS_BRANCH_BANK_GL_MAPPING WHERE ISDELETED=0 AND (@BRANCH_ID=0 OR BRANCH_ID=@BRANCH_ID) ORDER BY 'Text' ";
        ...
        public CResult InsertCashChqPaymentInfo (Dictionary<String, String> oParam)
        {
            ...
            try
            {
                ...
                objList[7] = new SqlParameter("@PAYMENT_GL_ACC_ID", oParam["PAYMENT_GL_ACC_ID"]);
        ...
        {
            CResult CResult = new CResult();
            String Query = @"SP_DELETE_TRANSACTION_CASH_CHQ_PAYMENT";
