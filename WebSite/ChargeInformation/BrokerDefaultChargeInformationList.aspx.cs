...
public partial class ChargeInformation_BrokerDefaultChargeInformationList : System.Web.UI.Page
{
    bool Page_Read = true;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        Master.ShowPageNavigationURL("Add New", "~/ChargeInformation/BrokerDefaultChargeInformation.aspx");
    }
    ...
    private void DeleteBrokerDefaultChargeInfo(String ID)
    {
        ...
        CResult = BLLBrokerDefaultChargeInformation.DefaultBrokerDefaultChargeInfo(ID);
    ...
    private void GetGridviewControlData()
    {
        BLLBrokerDefaultChargeInformation BLLBrokerDefaultChargeInformation = new BLLBrokerDefaultChargeInformation();
        CResult CResult = new CResult();
        CResult = BLLBrokerDefaultChargeInformation.GetBrokerDefaultChargeInfo("0", txtSearchText.Text.Trim());
    ...
    protected void dgvChargeInformation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (Page_Read)
                e.Row.Cells[9].Text = "<img src='../Images/Icon/icon_edit_small.png' align='absbottom' /> <a href='BrokerDefaultChargeInformation.aspx?ID=" + drv["ID"].ToString() + "'>Edit</a>";
            else
                e.Row.Cells[9].Text = "&nbsp;";

            if (Page_Delete)
                e.Row.Cells[10].Text = "<img src='../Images/Icon/icon_delete_small.png' align='absbottom' /> <a href='BrokerDefaultChargeInformationList.aspx?action=Delete&ID=" + drv["ID"].ToString() + "' onclick='return confirm(\"Are you sure you wish to delete this Data?\")'>Delete</a>";
            else
                e.Row.Cells[10].Text = "&nbsp;";
        }
    }
