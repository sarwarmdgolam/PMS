<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true"
    CodeFile="BrokerTypeWiseChargeSettings.aspx.cs" Inherits="ChargeInformation_BrokerTypeWiseChargeSettings"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    <table style="width: 100%;">
        <tr>
            <td>
                Charge Settings Type<span class="asterisk">*</span></td>
            <td>
                <asp:DropDownList ID="ddlChargeSettingsType" runat="server" SkinID="ddl100" AutoPostBack="true"
                    OnSelectedIndexChanged="ddlChargeSettingsType_SelectedIndexChanged">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfddlChargeSettingsType" ControlToValidate="ddlChargeSettingsType"
        ...
        <tr>
            <td style="width: 20%">
                Charge Applied On<span class="asterisk">*</span></td>
            <td style="width: 80%">
                <asp:DropDownList ID="ddlChargeSettingsValue" runat="server" SkinID="ddl200">
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfddlChargeSettingsValue" ControlToValidate="ddlChargeSettingsValue"
                    InitialValue="0" Display="None" Text="*" ValidationGroup="a" runat="server" ErrorMessage="Charge Type value."></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 20%">
            ...
            <td>
                <div style="width: 100%;">
                    <asp:GridView ID="gvChargeInformation" runat="server" AutoGenerateColumns="False"
                        ...
                        DataKeyNames="ID,TYPEWISE_CHARGE_ID" OnRowDataBound="gvChargeInformation_RowDataBound"
                        CssClass="mGrid">
                        <Columns>
