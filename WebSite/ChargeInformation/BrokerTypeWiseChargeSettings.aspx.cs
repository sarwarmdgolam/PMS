...
public partial class ChargeInformation_BrokerTypeWiseChargeSettings : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        MasterPage_Default Master = (MasterPage_Default)this.Master;
        Master.ShowPageNavigationURL("View List", "~/ChargeInformation/BrokerTypeWiseChargeSettingsList.aspx");
    }
    ...
    {
        //Populate ddlChargeSettingsType
        ddlChargeSettingsType.DataTextField = "Text";
        ddlChargeSettingsType.DataValueField = "Value";
        ddlChargeSettingsType.DataSource = BLLCommonEntity.GetCommonEntityData(ApplicationEnums.EntityEnum.ChargeSettingsType).Data;
        ddlChargeSettingsType.DataBind();
    ...
    private void GetDDLChargeSettingsBySelectedType()
    {
        CResult CResult = new CResult();
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult = BLLBrokerTypeWiseChargeSettings.GetDDLChargeSettingsBySelectedType(ddlChargeSettingsType.SelectedValue);
        if (CResult.Data.Rows.Count > 0)
        {
            ddlChargeSettingsValue.DataTextField = "Text";
            ddlChargeSettingsValue.DataValueField = "Value";
            ddlChargeSettingsValue.DataSource = CResult.Data;
            ddlChargeSettingsValue.DataBind();
        }
    }
    ...
    private void GetBrokerDefaultChargeInfoFromDB(String ID)
    {
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult CResult = new CResult();
        CResult = BLLBrokerTypeWiseChargeSettings.GetBrokerTypewiseChargeInfo(ID, String.Empty);
    ...
    private Dictionary<String, String> GetBrokerDefaultChargeInfo()
    {
        ...
        oParam["CHARGE_TYPE_ID"] = ddlChargeSettingsType.SelectedValue;
        oParam["TYPEWISE_VALUE_ID"] =ddlChargeSettingsValue.SelectedValue;
    ...
    private void SetBrokerDefaultChargeInfo(DataRow Row)
    {
        try
        {
            ...
            ddlChargeSettingsType.SelectedValue = Row["CHARGE_TYPE_ID"].ToString();
            ddlChargeSettingsType_SelectedIndexChanged(null, null);
            ddlChargeSettingsValue.SelectedValue= Row["TYPEWISE_VALUE_ID"].ToString();
            ddlChargeInformation.SelectedValue = Row["CHARGE_ID"].ToString();
    ...
    private void InsertBrokerDefaultChargeInfo()
    {
        ...
        CResult CResult = new CResult();
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult = BLLBrokerTypeWiseChargeSettings.InsertBrokerTypewiseChargeInfo(GetBrokerDefaultChargeInfo());
    ...
    private void UpdatetBrokerDefaultChargeInfo()
    {
        ...
        CResult CResult = new CResult();
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult = BLLBrokerTypeWiseChargeSettings.UpdateBrokerTypewiseChargeInfo(GetBrokerDefaultChargeInfo());
    ...
    private Dictionary<String, String> GetBrokerDefaultChargeSlabInfo(GridViewRow oRow)
    {
        ...
        if (oRow != null)
        {
            oParam["TYPEWISE_CHARGE_ID"] = hdnID.Value;
    ...
    private void InsertBrokerDefaultChargeSlabInfo(Dictionary<String, String> oParam)
    {
        ...
        CResult CResult = new CResult();
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult = BLLBrokerTypeWiseChargeSettings.InsertBrokerTypewiseChargeSlabInfo(oParam);
    ...
    private void GetGridviewControlData()
    {
        BLLBrokerTypeWiseChargeSettings BLLBrokerTypeWiseChargeSettings = new BLLBrokerTypeWiseChargeSettings();
        CResult CResult = new CResult();
        CResult = BLLBrokerTypeWiseChargeSettings.GetBrokerTypewiseChargeSlabInfo(hdnID.Value);
        if (CResult.IsSuccess)
        {
    ...
    {
        Response.Redirect("BrokerTypeWiseChargeSettings.aspx");
    }
    protected void ddlChargeSettingsType_SelectedIndexChanged(object sender, EventArgs e)
    {
        GetDDLChargeSettingsBySelectedType();
    }
}
