...
public partial class AccountTransaction_ApproveCashChqCollection : System.Web.UI.Page
{
    ...
    private void GetCashChqCollection()
    {
        ...
        CResult = BLLCashChqCollectionManagement.GetUnApprovedCashChqDepositInfo(txtTransactionDate.Text);
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        CResult = BLLCashChqCollectionManagement.ApprovedCashChqDepositInfo(oParamList);
