<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true"
    CodeFile="CashChqCollectionClearDishonour.aspx.cs" Inherits="AccountTransaction_CashChqCollectionClearDishonour"
    Title="Untitled Page" %>
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:Button ID="btn_Save" runat="server" Text="Honour" OnClick="btn_Save_Click" ValidationGroup="insert"
                        CausesValidation="true" />
                </td>
                <td>
                    <asp:HiddenField ID="HiddenField1" runat="server" />
                    <asp:Button ID="btn_Deny" runat="server" Text="Dishonour" OnClick="btn_Deny_Click"
