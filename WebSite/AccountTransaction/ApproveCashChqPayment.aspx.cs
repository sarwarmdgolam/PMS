...
public partial class AccountTransaction_ApproveCashChqPayment : System.Web.UI.Page
{
    ...
    {
        BLLCashChqPaymentManagement BLLCashChqPaymentManagement = new BLLCashChqPaymentManagement();
        CResult CResult = new CResult();
        CResult = BLLCashChqPaymentManagement.GetUnApprovedCashChqPaymentInfo( txtTransactionDate.Text);
    ...
    protected void gvCashCheque_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (string.IsNullOrEmpty(drv["CHEQUE_DT"].ToString()))
                ...
                st.Append("<b>Date:</b> " + drv["CHEQUE_DT"].ToString() + "<br /><br />");
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        CResult = BLLCashChqPaymentManagement.ApprovedCashChqPaymentInfo(oParamList);

        if (CResult.AffectedRows>0)
        {
            (this.Master as MasterPage_Default).ShowApplicationMessage(ApplicationEnums.ApplicationMessageType.Informaiton, "Successfully approved payment. No# " + CResult.AffectedRows.ToString());
    ...
    {
        Response.Redirect("../AccountTransaction/ApproveCashChqPayment.aspx");
    }
}
