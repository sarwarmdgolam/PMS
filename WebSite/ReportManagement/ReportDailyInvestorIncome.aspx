<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true"
    CodeFile="ReportDailyInvestorIncome.aspx.cs" Inherits="ReportManagement_ReportDailyInvestorIncome"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <table width="100%">
        <tr>
            <td colspan="2">
                <asp:RadioButtonList ID="rbtnReportTypeList" runat="server">
                    <asp:ListItem Value="REPORT_INVESTOR_WISE_DAILY_INCOME" Selected="True">Investor Wise Daily Income</asp:ListItem>
                    <asp:ListItem Value="REPORT_INVESTOR_WISE_DAILY_INCOME_SUMMARY">Investor Wise Daily Income Summary</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>
        <tr>
