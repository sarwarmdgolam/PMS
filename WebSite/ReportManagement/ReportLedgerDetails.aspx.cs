...
public partial class ReportManagement_ReportLedgerDetails : System.Web.UI.Page
{
    ...
    {
        string strReportPath = Server.MapPath(@"../Reports/" + ReportName + "SP_REPORT_INVESTOR_LEDGER_DETAILS.rpt");
