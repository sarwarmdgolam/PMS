...
public partial class ReportManagement_ReportDailyInvestorIncome : System.Web.UI.Page
{
    ...
    {
        string strReportPath = Server.MapPath(@"../Reports/" + ReportName + rbtnReportTypeList.SelectedValue +".rpt");
    ...
    protected void PreviewReport(ApplicationEnums.ReportPreviewType sFormat, String Investor_Code, String FROM_DATE, String TO_DATE)
    {
        ...
        objReportDocument.SetParameterValue("@FROM_DATE", TypeCasting.ToDateTime(FROM_DATE));
        objReportDocument.SetParameterValue("@TO_DATE", TypeCasting.ToDateTime(TO_DATE));
