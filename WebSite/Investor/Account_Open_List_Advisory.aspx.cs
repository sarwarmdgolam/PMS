...
public partial class Investor_Account_Open_List_Advisory : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        MasterPage_Default Master = (MasterPage_Default)this.Master;
        Master.ShowPageTitle("Account Open(Advisory)");
        Master.ShowPageNavigationURL("Add New", "~/Investor/CustomerAccountOpenAdvisory.aspx");
    }
    ...
    protected void gv_Account_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //Edit
            e.Row.Cells[4].Text = "<img src='../Images/Icon/icon_edit_small.png' align='absbottom' /> <a href='../Investor/CustomerAccountOpenAdvisory.aspx?ID=" + drv["ID"].ToString() + "'>Edit</a>";
            
            //Delete
            e.Row.Cells[5].Text = "<img src='../Images/Icon/icon_delete_small.png' align='absbottom' /> <a href='../Investor/Account_Open_List_Advisory.aspx?action=Delete&ID=" + drv["ID"].ToString() + "' onclick='return confirm(\"Are you sure you wish to delete this record?\")'>Delete</a>";
        }
    }
