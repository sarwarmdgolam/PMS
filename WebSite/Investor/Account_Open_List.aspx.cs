...
public partial class Investor_Account_Open_List : System.Web.UI.Page
{
    ...
    protected void gv_Account_List_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //Edit
                e.Row.Cells[3].Text = "<img src='../Images/Icon/icon_edit_small.png' align='absbottom' /> <a href='../Investor/Customer_Account_Open.aspx?ID=" + drv["ID"].ToString() + "&ACC_TYPE_ID="+drv["ACC_TYPE_ID"].ToString()+"'>Edit</a>";
            
            //Delete
            e.Row.Cells[4].Text = "<img src='../Images/Icon/icon_delete_small.png' align='absbottom' /> <a href='../Investor/Account_Open_List.aspx?action=Delete&ID=" + drv["ID"].ToString() + "' onclick='return confirm(\"Are you sure you wish to delete this record?\")'>Delete</a>";
        }
    }
