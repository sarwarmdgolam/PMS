<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true"
    CodeFile="Account_Open_List_Advisory.aspx.cs" Inherits="Investor_Account_Open_List_Advisory" Title="Account Open List(Advisory)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
  <%--  <table width="100%">
            ...
            <td colspan="2">
                <div style="width: 100%; background-color: #99CCCC;">
                    ...
                    <div style="float: right;">
                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Underline="true" PostBackUrl="~/Investor/CustomerAccountOpenAdvisory.aspx">Add New</asp:LinkButton>
                    </div>
                </div>
            </td>
        </tr>
     ...
     <%--<div style="float: right;">
            <a href="Account_Open_List_Advisory.aspx" style="text-underline-position: below">View
                List</a>
        </div>--%>
    <div>
        <fieldset>
                    ...
                    <div style="width: 100%; overflow: auto;">
                        <asp:GridView ID="gv_Account_List" runat="server" AutoGenerateColumns="False" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CORPORATENAME" HeaderText="Name" />
