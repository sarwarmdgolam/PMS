<%@ Page Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true"
    CodeFile="Account_Open_List.aspx.cs" Inherits="Investor_Account_Open_List" Title="Account Open List" %>
            ...
            <td colspan="2">
                <div style="width: 100%; background-color: #99CCCC;">
                    ...
                    <div style="float: right;">
                        <asp:LinkButton ID="LinkButton1" runat="server" Font-Underline="true" PostBackUrl="~/Investor/Customer_Account_Open.aspx">Add New</asp:LinkButton>
                    </div>
                </div>
            </td>
        </tr>
