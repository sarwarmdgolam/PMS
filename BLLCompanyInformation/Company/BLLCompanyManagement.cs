    ...
    public class BLLCompanyManagement
    {
        ...
        public CResult InsertInstrumentSectorInfo(Dictionary<String, String> oParams)
        {
            ...
            try
            {
                ...
                objList[2] = new SqlParameter("@INST_SECTOR_TYPE_ID", TypeCasting.ToInt16( oParams["INST_SECTOR_TYPE_ID"]));
        ...
        public CResult GetCompanySectorInformation(String ID,String INST_SECTOR_TYPEID)
        {
            CResult CResult = new CResult();
            ...
            try
            {
                ...
                objList[1] = new SqlParameter("@INST_SECTOR_TYPE_ID", TypeCasting.ToInt16(INST_SECTOR_TYPEID));
